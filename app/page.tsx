...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-transparent text-indigo-950 selection:bg-indigo-100 selection:text-indigo-900">
      ...
      <div className={`fixed top-8 left-8 z-50 flex items-center gap-6 transition-all duration-700 ${isScrolled || loadingPhase !== 'done' ? 'opacity-0 -translate-y-10 pointer-events-none' : 'opacity-100 translate-y-0'}`}>
        ...
        <div className="flex items-center gap-4 pl-4 border-l border-indigo-200">
          <a
            ...
            className="text-indigo-900/70 hover:text-indigo-950 transition-colors duration-300 hover:scale-110"
          >
            <FaGithub size={20} />
          </a>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-indigo-900/70 hover:text-blue-600 transition-colors duration-300 hover:scale-110"
          >
            <FaLinkedin size={20} />
          </a>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group relative text-indigo-900/70 hover:text-indigo-950 transition-colors duration-300 hover:scale-110"
          >
      ...
      <div className={`relative z-20 transition-all duration-1000 ${loadingPhase === 'done' ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10 overflow-hidden'}`}>
        ...
        <section id="home" className="relative flex min-h-screen flex-col items-center justify-center px-6 text-center select-none">
          <div className="max-w-5xl space-y-12">
            ...
            <p className="mx-auto max-w-2xl text-lg text-indigo-900/80 sm:text-xl font-light tracking-wide animate-fade-in opacity-0 leading-relaxed drop-shadow-sm" style={{ animationDelay: '0.6s' }}>
            ...
            <div className="flex flex-nowrap justify-start md:justify-center gap-6 max-w-7xl mx-auto px-10 pb-10">
              {[
                ...
                >
                  ...
                  <div
                    className="absolute inset-0 bg-gradient-to-br from-white/90 via-indigo-50/80 to-slate-100/90 border border-indigo-100 backdrop-blur-sm transition-all duration-500 group-hover:from-indigo-500/90 group-hover:to-purple-500/90 group-hover:drop-shadow-[0_0_30px_rgba(129,140,248,0.4)]"
          ...
          <div className="flex flex-wrap justify-center gap-12 max-w-4xl">
            {['React', 'Next.js', 'Typescript', 'Tailwind', 'Node.js', 'Python', 'Figma', 'GraphQL'].map((skill) => (
              <div key={skill} className="flex flex-col items-center gap-6 group">
                <div className="w-28 h-28 rounded-full bg-white border border-indigo-100 flex items-center justify-center text-indigo-900 transition-all duration-700 ease-[cubic-bezier(0.175,0.885,0.32,1.275)] group-hover:bg-indigo-600 group-hover:border-indigo-400 group-hover:text-white group-hover:rotate-[360deg] group-hover:scale-125 shadow-lg group-hover:shadow-[0_0_40px_rgba(79,70,229,0.3)]">
                  <span className="text-xs font-black uppercase tracking-widest">{skill}</span>
                </div>
                <span className="text-sm font-bold text-indigo-900/40 group-hover:text-indigo-900 transition-all duration-500 group-hover:translate-y-2 uppercase tracking-tighter opacity-0 group-hover:opacity-100">
                  {skill}
                </span>
              </div>
            ))}
        ...
        <section id="contact" className="min-h-screen flex flex-col items-center justify-center py-24 px-6 bg-transparent">
          <div className="max-w-4xl w-full text-center space-y-12">
            ...
            <p className="text-xl md:text-2xl text-indigo-900/80 max-w-2xl mx-auto leading-relaxed font-semibold">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8 pt-8">
              <div className="flex items-center gap-6">
                <a
                  ...
                  className="group relative inline-block px-12 py-4 rounded-full bg-indigo-900 text-white font-black text-xl hover:scale-105 transition-all duration-300 hover:shadow-[0_0_50px_rgba(79,70,229,0.3)] overflow-hidden"
                >
                  <span className="relative z-10">Send Message</span>
                  <div className="absolute inset-0 bg-gradient-to-r from-indigo-800 to-indigo-950 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </a>

                <a
                  href="mailto:aastha0328kumari@gmail.com"
                  className="w-16 h-16 rounded-full bg-indigo-50 border border-indigo-100 flex items-center justify-center text-indigo-900/60 hover:text-indigo-900 hover:bg-indigo-100 transition-all duration-300 hover:scale-110 active:scale-95"
                  title="Email Me"
                >
                  <FaEnvelope size={28} />
                </a>
              ...
              <div className="flex items-center gap-6 px-8 py-4 bg-white rounded-full border border-indigo-100 shadow-sm backdrop-blur-xl">
                <a href="https://github.com/aasthakumari03" target="_blank" className="text-indigo-900/60 hover:text-indigo-900 transition-colors"><FaGithub size={24} /></a>
                <a href="https://www.linkedin.com/in/aastha-kumari-2116a837a" target="_blank" className="text-indigo-900/60 hover:text-blue-600 transition-colors"><FaLinkedin size={24} /></a>
                <a href="https://www.instagram.com/the_nytheris/" target="_blank" className="text-indigo-900/60 hover:text-pink-600 transition-colors"><FaInstagram size={24} /></a>
              </div>
            </div>
          ...
          <div className="absolute bottom-8 left-1/2 -translate-x-1/2">
            ...
            >
              <div className="w-4 h-4 rounded-full border border-indigo-300 bg-indigo-50 animate-pulse group-hover:bg-indigo-600 group-hover:scale-125 transition-all duration-300 shadow-[0_0_10px_rgba(79,70,229,0.2)]" />
              <span className="text-[10px] font-mono tracking-[0.4em] text-indigo-900/30 group-hover:text-indigo-900 uppercase transition-colors">Click here</span>
            </button>
          </div>
        </section>
      </div>
