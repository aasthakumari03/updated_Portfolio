...
const ProjectCard: React.FC<ProjectCardProps> = ({
    ...
    return (
        <div
            ...
            className={`group relative w-full overflow-hidden rounded-[2.5rem] bg-transparent spotlight-card spotlight-border shimmer-border hover-lift-up mb-12 flex flex-col md:flex-row ${reversed ? 'md:flex-row-reverse' : ''} transition-all duration-700`}
        >
            {/* Content Section */}
