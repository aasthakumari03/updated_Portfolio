        ...
        <div className="animate-fade-in opacity-0" style={{ animationDelay: '0.8s' }}>
            <div className="group relative w-36 h-20 rounded-lg bg-[var(--card-bg)] border border-[var(--card-border)] backdrop-blur-xl transition-all duration-500 hover:border-indigo-500/50 hover:shadow-[0_0_30px_rgba(79,70,229,0.3)] hover:scale-110 flex items-center justify-center p-3 cursor-pointer overflow-hidden">
                ...
                <div className="relative z-10 flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-blue-600/10 flex items-center justify-center text-blue-400 group-hover:scale-110 group-hover:bg-blue-600 group-hover:text-white transition-all duration-500">
                        <FaFilePdf size={16} />
                    </div>

                    <div className="text-left">
                        <h3 className="text-sm font-bold text-[var(--foreground)] uppercase tracking-wider">Resume</h3>
                    </div>
                </div>
